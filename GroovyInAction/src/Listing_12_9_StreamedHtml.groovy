        ...
        body {
            plan.week.eachWithIndex { week, i ->
                ...
                week.task.each { task ->
                    ...
                    dd(
    "(${task.'@done'}/${task.'@total'}): $status")
}   }   }   }   }   }

def heater = new groovy.xml.StreamingMarkupBuilder().bind(markup) //#5

new File('data/StreamedGroovyPlans.html').withWriter{ it << heater }//#6
